...
Estos notebooks se encuentran disponibles como material complementario en un repositorio de GitHub, con el objetivo de facilitar la reproducibilidad y revisión del flujo desarrollado.
...
El código desarrollado durante el trabajo, incluyendo los notebooks principales de preprocesado, generación molecular, scoring y análisis final, se encuentra disponible en un repositorio público de GitHub:

\vspace{0.1cm}
\begin{center}
\url{https://github.com/kluna1998/smiles-molecule-generator-etl}
\end{center}
\vspace{0.1cm}

El repositorio se proporciona como material complementario para facilitar la revisión, trazabilidad y reproducibilidad del flujo computacional descrito en esta memoria.
